...
const Input = ({
  ...
  return (
    <div className="relative z-0 w-full mb-6 group">
      ...
      />
      <label className="peer-focus:font-medium font-bold  absolute text-sm text-title duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-title peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
