...
const GeneralMessage = ({ file, message }) => {
  return (
    <div className="bg-gray-300 transition duration-350 ease-in-out mr-96 rounded-lg rounded-bl-none">
      ...
      {message && <div className="pl-3 pb-1">
