...
import { usePostGradeStudentMutation, setExamSessionId } from '../../../store';
import { useForm } from 'react-hook-form';
import Input from '../../../components/App/Input';
const GradeExamForm = () => {
  const { examSessionId } = useSelector((state) => {
  ...
  const handleGradeSubmission = (body) => {
    body.examSessionId = examSessionId;
    console.log(body);
    gradeStudent(body);
  };
  useEffect(() => {
